module.exports = [
"[project]/.next-internal/server/app/api/store/dashboard/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/store/dashboard/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Get Products Count
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].product.count({
            where: {
                storeId
            }
        });
        // Calculate Totals
        const totalEarnings = orders.filter((o)=>o.isPaid).reduce((acc, order)=>acc + order.total, 0);
        // Unique Customers
        const uniqueCustomers = new Set(orders.map((o)=>o.userId)).size;
        // Chart Data (Last 7 days)
        const salesChart = Array.from({
            length: 7
        }, (_, i)=>{
            const d = new Date();
            d.setDate(d.getDate() - i);
            const dateStr = d.toLocaleDateString();
            const dayRevenue = orders.filter((o)=>new Date(o.createdAt).toLocaleDateString() === dateStr && o.isPaid).reduce((acc, o)=>acc + o.total, 0);
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c51b6f83._.js.map