module.exports = [
"[project]/.next-internal/server/app/api/admin/approve-store/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/admin/approve-store/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (status === 'approved') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].store.update({
                where: {
                    id: storeId
                },
                data: {
...
async function GET(request) {
    try {
        ...
        const stores = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].store.findMany({
            where: {
                status: {
                    in: [
                        "pending",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a904da93._.js.map