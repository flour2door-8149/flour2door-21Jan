module.exports = [
"[project]/.next-internal/server/app/api/store/is-seller/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/store/is-seller/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const isSeller = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$middlewares$2f$authSeller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(userId);
        if (!isSeller) {
        ...
        const storeInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].store.findUnique({
            where: {
                userId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b90c6638._.js.map