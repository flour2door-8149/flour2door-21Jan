module.exports = [
"[project]/.next-internal/server/app/api/rating/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/rating/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.findUnique({
            where: {
                id: orderId,
                userId
            }
        ...
        const isAlreadyRated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].rating.findFirst({
            where: {
                productId,
                orderId
            }
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].rating.create({
            data: {
                userId,
                productId,
                rating,
...
async function GET(request) {
    try {
        ...
        const ratings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].rating.findMany({
            where: {
                userId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__549fb0d7._.js.map