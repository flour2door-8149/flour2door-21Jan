module.exports = [
"[project]/.next-internal/server/app/api/admin/coupon/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/middlewares/authAdmin.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = authAdmin;
}),
"[project]/app/api/admin/coupon/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$middlewares$2f$authAdmin$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/middlewares/authAdmin.js [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const isAdmin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$middlewares$2f$authAdmin$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(userId);
        if (!isAdmin) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].coupon.create({
            data: coupon
        }).then(async (coupon)=>{
            // Run Inngest Sheduler Function to delete coupon on expire
            await __TURBOPACK__imported__module__$5b$project$5d2f$inngest$2f$client$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inngest"].send({
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].coupon.delete({
            where: {
                code
            }
        });
...
async function GET(request) {
    try {
        ...
        const coupons = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].coupon.findMany({});
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            coupons
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a8537c9._.js.map