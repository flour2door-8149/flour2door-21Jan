...
function AdminStores() {
    ...
    const fetchStores = async ()=>{
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/admin/stores', {
                headers: {
    ...
    const toggleIsActive = async (storeId)=>{
        try {
            const token = await getToken();
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admin/toggle-store', {
                storeId
            }, {
                headers: {
                    Authorization: "Bearer ".concat(token)
...
_s(AdminStores, "1jMP/ayVl+Lkfo8OvXNcRkF/K5M=", false, function() {
    return [
...
//# sourceMappingURL=_bfae4afb._.js.map