    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Flours ", path: '/', icon: null },
                { text: "grains", path: '/', icon: null },
                { text: "Custom Flours", path: '/', icon: null },
                { text: "Readymades", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91 8149090936", path: '/', icon: MailIcon },
                { text: "contact@flour2door.com", path: '/', icon: PhoneIcon },
                { text: "N3 Chh.Sambhajinagar, Maharashtra", path: '/', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Flour2</span>Door<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to flour2door, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © flour2door All Right Reserved.
                </p>
            </div>
        </footer>
    );
